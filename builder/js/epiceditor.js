  ...
  function EpicEditor(options) {
    ...
    var self = this
      ...
      , defaults = { container: 'epiceditor'
        ...
        , theme: { base: 'css/epiceditor.css',
			preview: 'css/preview-dark.css',
  ...
  EpicEditor.prototype.load = function (callback) {
    ...
    _HtmlTemplates = {
      ...
      chrome:   '<div id="epiceditor-wrapper" class="epiceditor-edit-mode">' +
                  '<iframe frameborder="0" id="epiceditor-editor-frame" ALLOWTRANSPARENCY="true"></iframe>' +
                  '<iframe frameborder="0" id="epiceditor-previewer-frame" ALLOWTRANSPARENCY="true" class="test"></iframe>' +
